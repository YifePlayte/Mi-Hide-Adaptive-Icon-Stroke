...
android {
    ...
    namespace = "com.yifeplayte.mihideadaptiveiconstroke"
    ...
    defaultConfig {
        applicationId = "com.yifeplayte.mihideadaptiveiconstroke"
        minSdk = 33
        targetSdk = 34
...
tasks.register<Zip>("assembleModule") {
    ...
    archiveFileName.set("mi-hide-adaptive-icon-stroke.zip")
}
